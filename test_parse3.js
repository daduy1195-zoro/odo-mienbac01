...
<body>
    ...
    <div id="globalLoading" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: var(--bg-primary); z-index: 9999; display: flex; flex-direction: column; align-items: center; justify-content: center; transition: opacity 0.5s ease;">
        ...
        <div style="font-size: 22px; font-weight: bold; margin-bottom: 25px; text-align: center; text-shadow: 1px 1px 2px rgba(0,0,0,0.1); color: var(--text-primary);">Khách hàng là người trả lương</div>
    ...
    <div id="authOverlay" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: var(--bg-primary); z-index: 10000; display: flex; flex-direction: column; align-items: center; justify-content: center; transition: opacity 0.3s ease;">
        <div style="background: var(--bg-card); padding: 40px 50px; border-radius: 16px; border: 1px solid var(--border); box-shadow: 0 10px 40px rgba(0,0,0,0.5); text-align: center; max-width: 500px; width: 92%;">
            <div style="font-size: 32px; font-weight: 900; margin-bottom: 8px; color: var(--text-primary);">Odo Dashboard</div>
            <p style="color: var(--text-secondary); margin-bottom: 25px; font-size: 14px; line-height: 1.6;">Vui lòng đăng nhập bằng tài khoản Google (Gmail) để tiếp tục sử dụng hệ thống và định danh thao tác.</p>
            <!-- Nút tiếp tục đăng nhập (cho người đã đăng nhập trước đó) -->
            <div id="authContinueBtn" style="display:none; margin-bottom: 16px;">
                <button onclick="continueAsUser()" style="width:100%; padding: 12px 20px; background: linear-gradient(135deg, #00c2a8, #00a389); color: #fff; border: none; border-radius: 8px; font-size: 15px; font-weight: 700; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 10px; transition: transform 0.1s ease;">
                    <img id="authContinueAvatar" src="" style="width:28px; height:28px; border-radius:50%;" referrerpolicy="no-referrer" onerror="this.style.display='none'">
                    <span id="authContinueName">Tiếp tục đăng nhập</span>
                </button>
            </div>
            <!-- Phân cách -->
            <div id="authDivider" style="display:none; margin: 16px 0; color: var(--text-muted); font-size: 12px;">── hoặc đăng nhập tài khoản khác ──</div>
            <!-- Nút đăng nhập Google -->
            <div id="g_id_onload"
                 data-client_id="854267293470-9pka8g6k8ksvft2n83o83vmh3qnbeu87.apps.googleusercontent.com"
                 data-context="signin"
                 data-ux_mode="popup"
...
<div class="container">
    ...
    <header class="header" id="header">
        ...
        <div class="header-right" style="flex-direction: row; gap: 16px;">
    ...
    <div class="section" id="tabNccTrip" style="display:none;">
        <div class="section-header">
            ...
            <div style="display:flex;gap:8px;align-items:center;">
                <button class="btn btn-primary" onclick="copyThcpAC()" style="padding:6px 14px;font-size:13px;background:#10b981;border-color:#10b981;" title="Copy toàn bộ mã chuyến đi đã ghép để dán thẳng vào cột AC của file THCP">📋 Copy cột AC (THCP)</button>
<select id="filterNccStatus" class="form-control" style="width: 160px; font-size: 13px;" onchange="renderNccTrip()">
                    ...
                    <option value="khong_chay">🛑 Không chạy vẫn tính tiền</option>
                </select>
        ...
        <div class="section-header">
            ...
            <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;">
                <select id="filterLastmileStatus" class="form-control" style="width: 150px; font-size: 13px;" onchange="if(typeof renderLastmile === 'function') renderLastmile()">
                    ...
                    <option value="chuyen_ao">👻 Chuyến ảo</option>
                </select>
