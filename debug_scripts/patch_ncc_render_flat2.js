...
const regexLoad = /let pivotData = \{\};[\s\S]*?renderNcc\(pivotData\);/g;
...
code = code.replace(regexLoad, replacementLoad.trim());

const regexRender = /function renderNcc\(pivotData\) \{[\s\S]*?container\.innerHTML = html;\s*\n?\}/g;
...
code = code.replace(regexRender, replacementRender.trim());

fs.writeFileSync('C:/Users/MSI/Desktop/AI/Odo/index.html', code);
console.log('Flat rendering applied without template literals.');
