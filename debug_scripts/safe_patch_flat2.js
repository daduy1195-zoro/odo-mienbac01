...
const loadEnd = code.indexOf('renderNcc(pivotData);', loadStart) + 21 + (code.substr(code.indexOf('renderNcc(pivotData);', loadStart) + 21, 5).includes('\r\n}') ? 4 : 2);

const renderStart = code.indexOf('function renderNcc(pivotData) {');
let renderEnd = code.indexOf('container.innerHTML = html;', renderStart);
renderEnd = code.indexOf('}', renderEnd) + 1;
