...
async function fetchSheet(sheet) {
    return new Promise((resolve) => {
        https.get(`https://docs.google.com/spreadsheets/d/${sheet.id}/gviz/tq?tqx=out:json&gid=${sheet.gid}&headers=1`, res => {
            let data = '';
            ...
            res.on('end', () => {
                try {
                    ...
                    json.table.rows.forEach(row => {
                        ...
                        if (rowStr.includes('29K-07561') || rowStr.includes('29K-01203')) {
