...
const targetStr = `if (typeof formatPlate === 'function') {
...
if (code.includes(targetStr) && !code.includes('fetchSupplementaryPlates')) {
    // Chèn hàm fetch trước hàm loadLastmileData
